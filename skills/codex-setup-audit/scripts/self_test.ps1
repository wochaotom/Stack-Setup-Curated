...
Add-Check "native-first selection policy" ($skill -match "Native-First Selection Policy" -and $skill -match "Target-native exact match" -and $skill -match "Target-native adjacent match" -and $skill -match "Cross-platform source" -and $skill -match "Do not make Codex the source of truth")
...
Add-Check "audit emits native-first selection policy" ($auditText -match "Native-First Skill Selection" -and $auditText -match "Target-native exact match" -and $auditText -match "cross-platform conversion last")
...
Add-Check "audit emits discussion plan" ($auditText -match "Discuss Before Installing" -and $auditText -match "target AI clients" -and $auditText -match "native marketplace" -and $auditText -match "Cursor" -and $auditText -match "Antigravity")
