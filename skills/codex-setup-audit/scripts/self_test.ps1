...
Add-Check "audit emits discussion plan" ($auditText -match "Discuss Before Installing" -and $auditText -match "target AI clients" -and $auditText -match "cross-ecosystem marketplaces" -and $auditText -match "Cursor" -and $auditText -match "Antigravity")
