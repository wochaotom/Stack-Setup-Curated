...
Add-Check "external skill discovery gated" ($skill -match "officialskills\.sh" -and $skill -match "discovery indexes, not trusted install sources" -and $skill -match "inspect the original GitHub repository")
